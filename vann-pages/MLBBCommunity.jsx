      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] flex items-center justify-center">
        ...
        <div className="relative z-20 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-black uppercase italic tracking-tighter mb-6 text-white drop-shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-[#F3B229] hover:bg-[#e0a020] text-black font-bold py-4 px-8 rounded-none uppercase tracking-wider transition-all duration-300 transform hover:scale-105 flex items-center gap-2">
                <Swords size={20} /> Join The Squad
              </button>
              <button className="bg-transparent border border-gray-600 hover:border-[#F3B229] hover:text-[#F3B229] text-white font-bold py-4 px-8 rounded-none uppercase tracking-wider transition-all duration-300 flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {players.map((player, idx) => (
            <motion.div 
              ...
              className="group relative bg-[#111111] overflow-hidden border border-gray-800 hover:border-[#F3B229] transition-colors"
            >
