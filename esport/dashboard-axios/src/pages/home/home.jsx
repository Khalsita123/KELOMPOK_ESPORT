...
// ============ DIVISION SECTION ============
const games = [
  { id: "pubg",      name: "PUBG MOBILE",      type: "mobile", accent: "#c8a000", bg: "linear-gradient(160deg, #1c2d4a, #0d1a30)", charImg: "" },
  { id: "freefire",  name: "FREE FIRE",         type: "mobile", accent: "#00bfff", bg: "linear-gradient(160deg, #0d2240, #050f20)", charImg: "" },
  { id: "mlbb",      name: "MOBILE LEGENDS",    type: "mobile", accent: "#d4a800", bg: "linear-gradient(160deg, #1a0a30, #0a0518)", charImg: "" },
  { id: "hok",       name: "HONOR OF KINGS",    type: "mobile", accent: "#ffd700", bg: "linear-gradient(160deg, #0d0d25, #050510)", charImg: "" },
  { id: "valorant",  name: "VALORANT",          type: "pc",     accent: "#ff4655", bg: "linear-gradient(160deg, #1a0a10, #0d0508)", charImg: "" },
  { id: "dota2",     name: "DOTA 2",            type: "pc",     accent: "#c23c2a", bg: "linear-gradient(160deg, #0a1a10, #050d08)", charImg: "" },
  { id: "cs2",       name: "COUNTER-STRIKE 2",  type: "pc",     accent: "#e8b04a", bg: "linear-gradient(160deg, #111108, #080804)", charImg: "" },
  { id: "pb",        name: "POINT BLANK",       type: "pc",     accent: "#00c853", bg: "linear-gradient(160deg, #0a1520, #050a10)", charImg: "" },
];
...
// ============ MATCH SECTION ============
const gameLogos = {
  "PUBG MOBILE":      "https://upload.wikimedia.org/wikipedia/en/9/9c/PUBG_Mobile_cover_art.jpg",
  "FREE FIRE":        "https://upload.wikimedia.org/wikipedia/en/6/6e/Garena_Free_Fire_Logo.jpg",
  "MOBILE LEGENDS":   "https://upload.wikimedia.org/wikipedia/en/9/92/Mobile_Legends_Bang_Bang_Logo.jpg",
  "VALORANT":         "https://upload.wikimedia.org/wikipedia/commons/f/fc/Valorant_logo_-_pink_color_version.png",
  ...
  "DOTA 2":           "https://upload.wikimedia.org/wikipedia/en/thumb/1/19/Dota_2_Logo.png/250px-Dota_2_Logo.png",
  "COUNTER-STRIKE 2": "https://upload.wikimedia.org/wikipedia/en/f/f2/CS2_Artwork.jpg",
  "POINT BLANK":      "https://upload.wikimedia.org/wikipedia/en/thumb/5/5d/Point_Blank_logo.png/250px-Point_Blank_logo.png",
};
  ...
  return (
    <section className="container my-5 text-white">
      ...
      <div className="card p-3">
        Tournament Hiling Strike Menang Regional
      </div>
    </section>
  );
}
      ...
      <div className="row">
        {creators.map((creator, index) => (
          <div className="col-md-4" key={index}>
            <div className="card p-3 text-center">{creator}</div>
          </div>
        ))}
      </div>
    </section>
...
function Partner() {
  const partners = [
    ...
    { name: "ROG", img: "" },
    { name: "Biznet", img: "" },
    { name: "AYANA Hospitality", img: "" },
    { name: "Pop Mie", img: "" },
    { name: "Sukro", img: "" },
    { name: "Virtu Digilab", img: "" },
    { name: "GODA", img: "" },
    { name: "ShopeePay", img: "" },
  ];
